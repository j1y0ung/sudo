...
function scene:create( event )
	...
	function Main()
		...
		icon = display.newImageRect("images/icon_connect.png", 200, 200)
		icon.x = display.contentCenterX
		icon.y = display.contentCenterY/1.8

		title = display.newText("Connect", icon.x, icon.y + 120, native.systemFont, 40)
		title:setFillColor(0.6, 0.6, 0.6)

		line1 = display.newRect(display.contentCenterX, display.contentCenterY*1.5, display.contentWidth, 100)
		--line1:setFillColor(0.2, 0.7, 0.4) --green
		line1:setFillColor(0.7, 0.7, 0.7) 
