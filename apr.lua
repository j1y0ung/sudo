...
function scene:create( event )
	...
	--전, 후달
	local goM = display.newText("3월", 50, 130, font, 45)
	goM:setFillColor(0)
	goM.name = "4-3"
	local goMay = display.newText("5월", 650, 130, font, 45)
	goMay:setFillColor(0)
	goMay.name = "4-5"
	...
	goM:addEventListener( "tap", tapListener )
	...
	--일정
	local promise1 = display.newText("월급", 140, 795)
	promise1.size = 30
	promise1:setFillColor(0)
	local promise2 = display.newText("엄마생신", 240, 625)
	promise2.size = 30
	promise2:setFillColor(0)
	...
	sceneGroup:insert(goMay)
	sceneGroup:insert(year_month)
	sceneGroup:insert(promise1)
	sceneGroup:insert(promise2)
