...
local scrollView = widget.newScrollView(
    {
 	...
 	--내역
	local text1 = display.newImageRect("text/b1.png",850, 6300)
	text1.x, text1.y = 400, 3150
	scrollView:insert( text1 )
	local text2 = display.newImageRect("text/b2.jpg",850, 670)
	text2.x, text2.y = 400, 6485
	scrollView:insert( text2 )
	--기본
	local person = display.newImageRect("001-user.png", 80, 80)
	person.x, person.y = 350, 125

	local name = display.newText("1588-1588", 350, 177, native.systemFont, 35)
    name:setFillColor( 0 )
