...
function scene:create( event )
	...
	--전, 후달
	local goS = display.newText("9월", 50, 130, font, 45)
	goS:setFillColor(0)
	goS.name = "10-9"
	local goN = display.newText("11월", 650, 130, font, 45)
	goN:setFillColor(0)
	goN.name = "10-11"

	--전, 후달 이동
	local function go_S()
		composer.showOverlay("sep")
		print("9월")
	end

	local function go_N()
		composer.showOverlay("nov")
		print("101월")
	end
	...
	promise[5] = display.newText( content[2], 440, 470 )
	promise[5].size = 30
	promise[5]:setFillColor(0)
	promise[6] = display.newText( content[2], 240, 965 )
	promise[6].size = 30
	promise[6]:setFillColor(0)
	promise[7] = display.newText( content[3], 140, 795 )
	promise[7].size = 30
	promise[7]:setFillColor(0)
	promise[8] = display.newText( content[3], 140, 795 )
	promise[8].size = 30
	promise[8]:setFillColor(0)
	promise[9] = display.newText( content[3], 440, 795 )
	promise[9].size = 30
	promise[9]:setFillColor(0)
	promise[10] = display.newText( content[4], 240, 470 )
	promise[10].size = 30
	promise[10]:setFillColor(0)
	promise[11] = display.newText( content[5], 40, 795 )
	promise[11].size = 30
	promise[11]:setFillColor(0)
	promise[12] = display.newText( content[6], 540, 470 )
	promise[12].size = 30
	promise[12]:setFillColor(0)
	promise[13] = display.newText( content[7], 440, 820)
	promise[13].size = 30
