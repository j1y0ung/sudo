...
local function gotoCluenote()
    print("단서노트 클릭")
    composer.removeScene("bConnect1")
...
function scene:create( event )
	...
	-- 하단바는 움직이지 않게
	local bottomBar = display.newImageRect("images/connectBottom_no.png", display.contentWidth, 150)
	bottomBar.x = display.contentCenterX
	bottomBar.y = 1132

	-- 내용 부분(여기는 안 길어서 스크롤 안 넣음)
	local content = display.newImageRect("images/connectC1.png", display.contentWidth, 410)
