...
local function gotoCluenote()
    print("단서노트 클릭")
    composer.removeScene("b2Connect5")
...
local function gotoHome()
    print("홈버튼 클릭")
    composer.removeScene("b2Connect6")
...
local function gotoBack()
    print("뒤로가기 버튼 클릭")
    composer.removeScene("b2Connect7")
...
function scene:create( event )
	...
	local content = display.newImageRect("images/connect2C5.png", display.contentWidth, 1650)
