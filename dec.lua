...
function scene:create( event )
	...
	local goN = display.newText("11월", 50, 130, font, 45)
	goN:setFillColor(0)
	goN.name = "12-11"
	local goJ = display.newText("1월", 650, 130, font, 45)
	goJ:setFillColor(0)
	goJ.name = "12-1"
	...
	goN:addEventListener("tap", go_N)
	goN:addEventListener( "tap", tapListener )
	goN:addEventListener( "tap", function() return true; end )

	goJ:addEventListener("tap", go_J)
	goJ:addEventListener( "tap", tapListener )
	...
	"아울렛", "마트", "병원"}
	local promise = {}
	promise[1] = display.newText( content[2], 240, 290 )
	promise[1].size = 30
	promise[1]:setFillColor(0)
	promise[2] = display.newText( content[2], 240, 625 )
	promise[2].size = 30
	promise[2]:setFillColor(0)
	promise[3] = display.newText( content[2], 340, 795 )
	promise[3].size = 30
	promise[3]:setFillColor(0)
	promise[4] = display.newText( content[3], 540, 290)
	promise[4].size = 30
	promise[4]:setFillColor(0)
	promise[5] = display.newText( content[3], 40, 625)
	promise[5].size = 30
	promise[5]:setFillColor(0)
	promise[6] = display.newText( content[3], 440, 795)
	promise[6].size = 30
	promise[6]:setFillColor(0)
	promise[7] = display.newText( content[4], 40, 965)
	promise[7].size = 30
	promise[7]:setFillColor(0)
	promise[8] = display.newText( content[5], 540, 625)
	promise[8].size = 30
	promise[8]:setFillColor(0)
	promise[9] = display.newText( content[6], 140, 470)
	promise[9].size = 30
	promise[9]:setFillColor(0)
	promise[10] = display.newText( content[7], 140, 795)
	promise[10].size = 30
