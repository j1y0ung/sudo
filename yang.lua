...
local scrollView = widget.newScrollView(
    {
 	...
 	--문자내용
	local text1 = display.newImageRect("text/y1.png",750, 6500)
	text1.x, text1.y = 370, 3230
	scrollView:insert( text1 )
	local text2 = display.newImageRect("text/y2.png",750, 6500)
	text2.x, text2.y = 370, 9700
	scrollView:insert( text2 )
	local text3 = display.newImageRect("text/y3.png",750, 3800)
	text3.x, text3.y = 360, 14850
	scrollView:insert( text3 )

    local this_do = display.newRect(250, 3850, 200, 70)
    this_do.alpha = 0.1
    scrollView:insert(this_do)

	local person = display.newImageRect("001-user.png", 80, 80)
	person.x, person.y = 350, 125

	local name = display.newText("지영맘", 350, 177, font, 35)
    name:setFillColor( 0 )


    local line_b = display.newRect( 600, 200, 1400, 10 )
	line_b:setFillColor( 0 )   -- white
    ...
    this_do:addEventListener("tap", do_this)
