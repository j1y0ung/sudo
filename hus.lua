...
function scene:create( event )
	...
	--문자내용
	local text1 = display.newImageRect("text/h1.PNG",750, 3500)
	text1.x, text1.y = 370, 1750
	scrollView:insert( text1 )
	local text2 = display.newImageRect("text/h2.jpg",750, 720)
	text2.x, text2.y = 370, 3650
	...
	local name = display.newText("남편", 350, 177, font, 35)
    name:setFillColor( 0 )
