...
local scrollView = widget.newScrollView(
    ...
    --문자내용
	local text1 = display.newImageRect("text/e1.PNG", 850, 2700)
	text1.x, text1.y = 400, 1350
	...
	local name = display.newText("010-1234-5678", 350, 177, font, 35)
    name:setFillColor( 0 )
