...
function scene:create( event )
	...
	--icon 
	local contact = display.newImageRect("images/button_co_un.png", 200, 120)
	contact.x = 200
	contact.y = bottomBar.y - 17

	local recentRButton = widget.newButton(
		{
			width = contact.width,
			height = contact.height,
			defaultFile = "images/button_rr.png",
			overFile = "images/button_rr_un.png",
			onPress = handleButtonEvent
		}
	)
	recentRButton.x = 500
	recentRButton.y = bottomBar.y - 17
	...
	local chatting = display.newImageRect("images/contactContents.png", display.contentWidth-50, 1600)
	...
	sceneGroup:insert( recentRButton )
	sceneGroup:insert(bottombar)
