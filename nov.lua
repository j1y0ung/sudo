...
function scene:create( event )
	...
	--전, 후달
	local goO = display.newText("10월", 50, 130, font, 45)
	goO:setFillColor(0)
	goO.name = "11-10"
	local goD = display.newText("12월", 650, 130, font, 45)
	goD:setFillColor(0)
	goD.name = "11-12"

	--잔, 후달 이동
	local function go_O()
		composer.showOverlay("oct")
		print("10월")
	end

	local function go_D()
		composer.showOverlay("dec")
		print("12월")
	end
	...
	promise[4] = display.newText( content[2], 240, 470 )
	promise[4].size = 30
	promise[4]:setFillColor(0)
	promise[5] = display.newText( content[2], 140, 625)
	promise[5].size = 30
	promise[5]:setFillColor(0)
	promise[6] = display.newText( content[3], 540, 470)
	promise[6].size = 30
	promise[6]:setFillColor(0)
	promise[7] = display.newText( content[3], 40, 965 )
	promise[7].size = 30
	promise[7]:setFillColor(0)
	promise[8] = display.newText( content[4], 440, 470 )
	promise[8].size = 30
	promise[8]:setFillColor(0)
	promise[9] = display.newText( content[5], 340, 795 )
	promise[9].size = 30
	promise[9]:setFillColor(0)
	promise[10] = display.newText( content[6], 240, 965 )
	promise[10].size = 30
	promise[10]:setFillColor(0)
	promise[11] = display.newText( content[7], 540, 795 )
	promise[11].size = 30
